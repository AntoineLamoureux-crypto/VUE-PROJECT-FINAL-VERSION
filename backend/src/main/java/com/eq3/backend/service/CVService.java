...
public class CVService {
    ...
    public Optional<Student> saveCV(String username, MultipartFile multipartFile) {
    ...
    public Optional<List<CV>> getAllCVS(String username){
        Optional<Student> student = studentRepository.findStudentByUsernameAndIsDisabledFalse(username);
        List<CV> cvList = student.get().getCVList();
        return Optional.ofNullable(cvList);
    }
