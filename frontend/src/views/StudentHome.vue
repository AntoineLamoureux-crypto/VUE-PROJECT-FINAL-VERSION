    ...
    <div class="container py-4">
      ...
      <div class="p-5 mb-4 bg-light rounded-3">
        <div class="container-fluid py-5">
          <h1 class="display-5 fw-bold">Liste de vos applications de stages</h1>
          //Add yourInternshipApplications here <br />
      ...
      <div class="row align-items-md-stretch">
        <div class="col-md-6">
          <div class="h-100 p-5 text-white bg-dark rounded-3">
            <h2>Nouvelles offres de stages</h2>
            //Add newinternshipOfferList here <br />
            <button class="btn btn-outline-light" type="button">Détails</button>
          </div>
        </div>
        <div class="col-md-6">
...
export default {
  components: { CVModalDeposit, CVList },
  name: "StudentHome",
  props: ["username"],
  data() {
    return {
